...
static uint8_t screenBuffer[SSD1306_SCREENBUFFER_SIZE_128_64];
...
int main(void)
{
    ...
    Graphics_position_t pos = graphics_getPosition();
    pos.y += 12;
    graphics_setPosition(pos);

    graphics_drawString("left", Graphics_color_white, Font_type_7x10,
